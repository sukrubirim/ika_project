...
static const _EmergencyStop_Request_type_support_symbol_names_t _EmergencyStop_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ika_msgs, srv, EmergencyStop_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ika_msgs, srv, EmergencyStop_Request)() {
  return &::ika_msgs::srv::rosidl_typesupport_c::EmergencyStop_Request_message_type_support_handle;
}
...
static const _EmergencyStop_Response_type_support_symbol_names_t _EmergencyStop_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ika_msgs, srv, EmergencyStop_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, ika_msgs, srv, EmergencyStop_Response)() {
  return &::ika_msgs::srv::rosidl_typesupport_c::EmergencyStop_Response_message_type_support_handle;
}
...
static const _EmergencyStop_type_support_symbol_names_t _EmergencyStop_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ika_msgs, srv, EmergencyStop)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, ika_msgs, srv, EmergencyStop)() {
  return &::ika_msgs::srv::rosidl_typesupport_c::EmergencyStop_service_type_support_handle;
}
