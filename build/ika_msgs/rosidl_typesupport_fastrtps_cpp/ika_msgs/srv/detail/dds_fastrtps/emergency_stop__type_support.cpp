...
#include "ika_msgs/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ika_msgs::srv::EmergencyStop_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ika_msgs::srv::EmergencyStop_Request & ros_message)
{
  // Member: stop
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ika_msgs::srv::EmergencyStop_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ika_msgs::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ika_msgs::srv::EmergencyStop_Request *>(
    untyped_ros_message);
...
{
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ika_msgs, srv, EmergencyStop_Request)() {
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ika_msgs
cdr_serialize(
  const ika_msgs::srv::EmergencyStop_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ika_msgs::srv::EmergencyStop_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ika_msgs::srv::EmergencyStop_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ika_msgs::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ika_msgs::srv::EmergencyStop_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ika_msgs, srv, EmergencyStop_Response)() {
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop_Response__handle;
}
...
{
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ika_msgs, srv, EmergencyStop)() {
  return &ika_msgs::srv::typesupport_fastrtps_cpp::_EmergencyStop__handle;
}
