...
#include "ika_msgs/srv/detail/emergency_stop__rosidl_typesupport_fastrtps_c.h"
...
using _EmergencyStop_Request__ros_msg_type = ika_msgs__srv__EmergencyStop_Request;
...
size_t get_serialized_size_ika_msgs__srv__EmergencyStop_Request(
  const void * untyped_ros_message,
...
static uint32_t _EmergencyStop_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ika_msgs__srv__EmergencyStop_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ika_msgs
size_t max_serialized_size_ika_msgs__srv__EmergencyStop_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ika_msgs__srv__EmergencyStop_Request;
    is_plain =
      (
...
static size_t _EmergencyStop_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ika_msgs__srv__EmergencyStop_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop_Request)() {
...
using _EmergencyStop_Response__ros_msg_type = ika_msgs__srv__EmergencyStop_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ika_msgs
size_t get_serialized_size_ika_msgs__srv__EmergencyStop_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EmergencyStop_Response__ros_msg_type * ros_message = static_cast<const _EmergencyStop_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ika_msgs__srv__EmergencyStop_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ika_msgs
size_t max_serialized_size_ika_msgs__srv__EmergencyStop_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ika_msgs__srv__EmergencyStop_Response;
    is_plain =
      (
...
static size_t _EmergencyStop_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ika_msgs__srv__EmergencyStop_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop_Response)() {
...
// already included above
// #include "ika_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ika_msgs/srv/emergency_stop.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, srv, EmergencyStop)() {
