...
#include "ika_msgs/msg/detail/environment_data__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // sensor_status
#include "rosidl_runtime_c/string_functions.h"  // sensor_status
...
using _EnvironmentData__ros_msg_type = ika_msgs__msg__EnvironmentData;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _EnvironmentData__ros_msg_type * ros_message = static_cast<const _EnvironmentData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: relative_humidity_percent
  {
    cdr << ros_message->relative_humidity_percent;
  }

  // Field name: pressure_pa
  {
  ...
  // Field name: rain_detected
  {
    cdr << (ros_message->rain_detected ? true : false);
  }

  // Field name: water_detected
  {
  ...
  void * untyped_ros_message)
{
  ...
  _EnvironmentData__ros_msg_type * ros_message = static_cast<_EnvironmentData__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_ika_msgs__msg__EnvironmentData(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _EnvironmentData__ros_msg_type * ros_message = static_cast<const _EnvironmentData__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _EnvironmentData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ika_msgs__msg__EnvironmentData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ika_msgs
size_t max_serialized_size_ika_msgs__msg__EnvironmentData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ika_msgs__msg__EnvironmentData;
    is_plain =
      (
...
static size_t _EnvironmentData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ika_msgs__msg__EnvironmentData(
...
static message_type_support_callbacks_t __callbacks_EnvironmentData = {
  "ika_msgs::msg",
  "EnvironmentData",
...
static rosidl_message_type_support_t _EnvironmentData__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_EnvironmentData,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ika_msgs, msg, EnvironmentData)() {
  return &_EnvironmentData__type_support;
}
