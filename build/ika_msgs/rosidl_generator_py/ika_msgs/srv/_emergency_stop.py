...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ika_msgs.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from ika_msgs.srv._emergency_stop import EmergencyStop_Request as Request
    from ika_msgs.srv._emergency_stop import EmergencyStop_Response as Response
